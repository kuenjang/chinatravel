...
function App() {
  ...
  const xiamenDetail = {
    ...
    overview: [
      { day: "Day 1", theme: "抵達鷺島，漫步騎樓", experience: "小三通/高鐵抵達、入住思明區、逛中山路步行街、品嚐在地小吃", budget: "住宿: 180-250元<br>餐飲: 80-120元" },
      { day: "Day 2", theme: "琴島鼓浪，萬國風華", experience: "搭輪渡登鼓浪嶼、日光岩、菽莊花園、漫步林巧稚紀念館", budget: "船票+門票: 100元<br>餐飲: 100-150元" },
      { day: "Day 3", theme: "雨林仙境，山海健康步道", experience: "萬石植物園噴霧雨林、多肉植物區、傍晚漫步山海健康步道看夕陽", budget: "門票: 30元<br>餐飲: 80-120元" },
      { day: "Day 4", theme: "環島椰風，海濱騎行", experience: "租單車騎行環島路（演武大橋-黃厝海灘）、在海邊沙灘喝咖啡發呆", budget: "交通: 20-50元<br>餐飲: 100-150元" },
      { day: "Day 5", theme: "八市尋味，沙坡尾文創", experience: "清晨探訪第八市場吃海鮮與沙茶麵、下午沙坡尾藝術西區、避風港看落日雙子塔", budget: "餐飲: 120-200元<br>其他: 30-50元" },
      { day: "Day 6", theme: "閩南學府，集美嘉庚風情", experience: "地鐵直達集美學村、龍舟池、鰲園、欣賞特色「穿西裝戴斗笠」嘉庚建築", budget: "交通: 15-30元<br>餐飲: 80-120元" },
      { day: "Day 7", theme: "海風輕拂，伴手好禮", experience: "八市買手信（餡餅、海產乾貨）、在海邊咖啡館處理工作後返程", budget: "伴手禮: 100-200元" }
    ],
    details: [
      { title: "Day 1：抵達鷺島，漫步騎樓", content: "經由金廈小三通五通碼頭或廈門站抵達。推薦在交通便利的思明區中山路附近落腳。晚上漫步於精美的閩南騎樓老街，喝一碗「黃則和」花生湯，吃碗熱騰騰的沙茶麵，正式開啟廈門慢活。" },
      { title: "Day 2：琴島鼓浪，萬國風華", content: "清晨從郵輪中心搭船登上鼓浪嶼。這裡沒有汽機車，全憑步行感受琴島的幽靜。登上日光岩俯瞰全島與波光粼粼的大海，漫步在鋪滿三角梅的紅磚別墅小巷，下午參觀菽莊花園與鋼琴博物館。" },
      { title: "Day 3：雨林仙境，山海健康步道", content: "早晨前往廈門園林植物園，在定時噴霧的雨林區拍攝如仙境般的陽光射線，並打卡巨大的網紅多肉植物。下午登上山海健康步道，用最美視角俯瞰廈門的城市天際線與海平線日落。" },
      { title: "Day 4：環島椰風，海濱騎行", content: "從演武大橋出發，租一輛單車沿著環島路騎行。沿途椰林樹影，海風徐徐。中途可以在黃厝沙灘停下，踩踩細沙，找家海景咖啡館抱著電腦辦公，享受無干擾的創作時光。" },
      { title: "Day 5：八市尋味，沙坡尾文創", content: "早起前往「八市」（第八市場），這是廈門煙火氣最濃的地方，品嚐最地道的薑母鴨和手撕雞。下午造訪沙坡尾避風港與藝術西區，感受傳統漁港與現代文創的完美融合，傍晚在此拍攝雙子塔的絕美剪影。" },
      { title: "Day 6：閩南學府，集美嘉庚風情", content: "搭乘地鐵跨海段（神似千與千尋海上火車）前往集美學村，漫步於清幽的龍舟池畔。這裡的建築融合了閩南紅磚與西洋風格，被稱為「穿西裝戴斗笠」。參觀陳嘉庚先生紀念館，感受濃厚的人文與愛國情懷。" },
      { title: "Day 7：海風輕拂，伴手好禮", content: "在海邊的精品咖啡館做最後的工作與行程整理。隨後前往八市或老字號採購著名的廈門餡餅、特製肉鬆與海鮮乾貨，帶著滿滿的創意與海風的鹹甜回憶啟程返程。" }
    ],
    spending: [
      "住宿：思明區便利民居月租約 2000-2800 RMB，湖里或集美約 1500-2000 RMB",
      "餐飲：小吃極多且平價，日均約 80-150 RMB 即可吃得非常好",
      "交通：地鐵、BRT 及共享單車覆蓋極廣，小三通船票單程約 130 RMB",
      "數位游牧：官任路外籍社區與沙坡尾一帶有眾多極具品味的咖啡館，對遠距工作者非常友善"
    ],
    prep: [
      "預訂：鼓浪嶼船票非常搶手，務必提前 3-5 天在「廈門輪渡+」微信小程序購票",
      "證件：小三通旅客請帶齊身分證、護照、台胞證等必要證件",
      "防曬：海濱城市紫外線極強，防曬乳、遮陽帽、墨鏡為每日必備",
      "防蚊：植物園及島上綠化極佳，建議隨身攜帶防蚊液"
    ]
  };
